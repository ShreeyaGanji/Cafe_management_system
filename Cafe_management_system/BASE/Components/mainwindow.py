...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        self.img = Image.open("C:\\Users\\SHREEYA\\Desktop\\Cafe_management_system\\Cafe_management_system\\assets\\cafe.jpg")
        self.img = self.img.resize((250, 250), Image.Resampling.LANCZOS)
        self.img = ImageTk.PhotoImage(self.img)
        self.panel = tk.Label(self.m_frame, image = self.img, text="CAFE MANAGEMENT  SYSTEM", compound='top', font=("Helvetica Bold", 20))
